...
<body class="bg-white" >
    <div class="fixed w-[100%]">
        <nav class=" shadow-md   bg-white  md:min-w-full md:h-16" > 
            ...
            <a class="lg:text-lg md:text-base underline text-red-400" href=" {{Route('FAQ')}} ">FAQ</a>
    ...
    <div class="text-center text-white pt-4 bg-black">

        <div class=" md:grid md:grid-cols-2 gap-x-6 md:mx-10 mb-6 mx-6">
            <div class="text-xs mb-8 mt- md:mt-20 ">
